export default function AnimatedBackground() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-[#f9f9ff]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_12%_22%,rgba(141,187,255,0.34),transparent_38%),radial-gradient(circle_at_88%_22%,rgba(198,183,255,0.27),transparent_36%),radial-gradient(circle_at_70%_58%,rgba(141,187,255,0.18),transparent_42%),radial-gradient(circle_at_50%_38%,rgba(255,255,255,0.72),transparent_40%),linear-gradient(180deg,#f9f9ff_0%,#f8fbff_45%,#ffffff_100%)]" />
