    ...
    <section className="pb-20 lg:pb-24">
      ...
      <Reveal>
        <div className="open-panel">
          <div className="relative z-10 hidden grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)_auto_minmax(0,1fr)_auto_minmax(0,1fr)_auto_minmax(0,1fr)] items-stretch md:grid md:gap-x-4">
            {steps.map((step, index) => (
              <Fragment key={step.title}>
                <article className="group col-span-1 flex min-w-0 flex-col rounded-[15px] border border-[#d4e3ff]/66 bg-white/64 p-4 shadow-[0_12px_34px_rgba(45,95,157,0.06)] transition-[border-color,box-shadow,background-color,transform] duration-300 hover:-translate-y-1 hover:border-[#8dbbff]/55 hover:bg-white/88 hover:shadow-[0_18px_48px_rgba(45,95,157,0.1)]">
                ...
                {index < steps.length - 1 ? (
                  <div className="col-span-1 flex shrink-0 items-center justify-center self-center px-1">
          ...
          <div className="relative z-10 grid gap-4 md:hidden">
            {steps.map((step, index) => (
              <div key={step.title} className="relative">
                ...
                {index < steps.length - 1 && (
                  <div className="relative mx-auto -my-1 flex h-8 w-8 items-center justify-center">
