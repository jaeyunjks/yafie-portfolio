    ...
    <section className="px-6 pb-24 pt-14">
      <Reveal>
        <div className="mx-auto max-w-5xl overflow-hidden rounded-[30px] border border-white/75 bg-white/62 p-8 text-center shadow-[0_28px_90px_rgba(45,95,157,0.13)] backdrop-blur-2xl md:p-10">
          <div className="mx-auto inline-flex rounded-full border border-[#d4e3ff]/75 bg-[#f8fbff]/82 px-4 py-2 font-mono text-[0.6rem] font-bold uppercase tracking-[0.16em] text-[#2d5f9d]/72">
            case.study.status
          </div>
